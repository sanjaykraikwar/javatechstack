...
import com.javatechstack.controller.CouponController;
...
/* Test case for get Coupon based on ID*/
	...
	//	when(couponRepository.findById(uId)).thenReturn(coupon);
	...
	public void testGetAllCoupon() {
        ...
        // define return value for method getUniqueId()
        when(couponRepository.findAll()).thenReturn((List<Coupon>) itCoupon);
